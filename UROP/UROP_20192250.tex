	...
	\begin{itemize}
		...
		\begin{tcolorbox}[colframe=magenta, breakable, enhanced]
			...
			\begin{proof}[\sol]
				\ 
				\begin{enumerate}[(1)]
					\item $\frac{1}{2^{\lambda/2}},\frac{1}{2^{\log(\lambda^2)}},\frac{1}{\lambda^{\log(\lambda)}},\frac{1}{\lambda^2},\frac{1}{2^{(\log\lambda)^2}},\frac{1}{2^{\sqrt{\lambda}}}$ are negligible functions.
					\item  $\frac{1}{(\log\lambda)^2},\frac{1}{\lambda^{1/\lambda}},\frac{1}{\sqrt{\lambda}}$ are non-negligible functions.
				\end{enumerate}
			\end{proof}
		\end{tcolorbox}
